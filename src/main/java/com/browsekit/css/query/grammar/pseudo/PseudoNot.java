...
import com.browsekit.css.query.tokens.pseudo.Not;

public class PseudoNot extends Grammar {

	public PseudoNot() {
		super(Grammar.SPECIFICITY_0_0_1);
	}

	public static Pattern pattern = Pattern.compile("^\\:not\\((.+)\\)", Pattern.CASE_INSENSITIVE);
	...
	public String match(String selector, SelectorPhraseList tokenList, CssSelectorTokenizer cssSelectorTokenizer) throws CssQueryUnknownGrammarException {
		...
		CssPseudoToken pseudoToken = new Not(cssParams);
