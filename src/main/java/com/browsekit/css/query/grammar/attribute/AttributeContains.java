...
import com.browsekit.css.query.tokens.attribute.Contains;
import com.browsekit.css.query.tokens.attribute.CssAttributeToken;

public class AttributeContains extends Grammar {

	public AttributeContains() {
	...
	public String match(String selector, SelectorPhraseList tokenList, CssSelectorTokenizer cssSelectorTokenizer) {
		...
		CssAttributeToken attribute = new Contains(matcher.group(1), matcher.group(2));
