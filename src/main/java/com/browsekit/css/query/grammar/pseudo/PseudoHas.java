...
import com.browsekit.css.query.tokens.pseudo.Has;

public class PseudoHas extends Grammar {

	public PseudoHas() {
		super(Grammar.SPECIFICITY_0_0_1);
	}

	public static Pattern pattern = Pattern.compile("^\\:has\\((.+)\\)", Pattern.CASE_INSENSITIVE);
	...
	public String match(String selector, SelectorPhraseList tokenList, CssSelectorTokenizer cssSelectorTokenizer) throws CssQueryUnknownGrammarException {
		...
		CssPseudoToken pseudoToken = new Has(cssParams);
